...
public class onClickOnTurret : MonoBehaviour
{
    ...
    public void onClickUITurretButton(string Name)
    {
        ...
        switch (Name)
        {
            ...
            case "sell":
                ...
                boardManager.GetComponent<BoardManager>().SetMoney(-sellPrice);
    ...
    private void upgradeTower()
    {
        ...
        switch (this.GetComponent<TurretBehaviour>().getTurretSelectedName())
        {
            case "STAR": //TOURELLE DE LA STAR
                ...
                {
                    boardManager.GetComponent<BoardManager>().SetMoney(upgradeCost);
    ...
    {
        if (cost < boardManager.GetComponent<BoardManager>().GetMoney())
        {
            return true;
        }
        else
