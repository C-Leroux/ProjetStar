...
namespace Assets.Scripts
{
    public class VictoryChoice
    {
        ...
        private string[] m_exemple = { "Vaisseau", "Base", "Money", "Turret", "MoneyForMerchant" };
        private string[] m_choix = { "ReduceTime", "AddMaxMoney", "AddDepartMoney", "AddMoneyPerSecond", "AddMaxLp", "AddNewTurret", "AddMoney" };
